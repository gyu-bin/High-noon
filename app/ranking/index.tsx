...
export default function RankingHubScreen() {
  ...
  }, [recordSeasonPeak, setDailyChallenge, setProfile, t]);
  ...
  const extraTitle = extra === 'season' ? t('ranking.seasonTitle') : '';
                  ...
                  <View style={styles.meMain}>
                    ...
                    <View style={styles.meText}>
                      ...
                      <Text style={styles.meMeta}>
                        {t(`ranking.tier.${parseRankTier(profile.rank_tier)}`)} ·{' '}
                        {profile.rating} ·{' '}
                    ...
                    >
                      ...
                      <View style={styles.rowMid}>
                        ...
                        <Text style={styles.rowMeta}>
                          {t(`ranking.tier.${parseRankTier(row.rank_tier)}`)} · {row.wins}W {row.losses}L
                        </Text>
                      </View>
                      <Text
                        style={[
